...
# Terminal: Fish + Starship + FiraCode Nerd Font + Dracula
...
install_apts() {
    ...
    done < "/home/luigibelanda/Programming/ShellScripts/pos_install/list_prog_apt.txt"
...
install_snap_and_flat() {
    ...
    done < "/home/luigibelanda/Programming/ShellScripts/pos_install/list_prog_snap.txt"

    # read lines -> list_prog_flat.txt
    while read line; do
        sudo flatpak install -y flathub $line
    done < "/home/luigibelanda/Programming/ShellScripts/pos_install/list_prog_flat.txt"
...
install_deb() {
    ...
    while read line; do
        sudo apt install $line -y
    done < "/home/luigibelanda/Programming/ShellScripts/pos_install/list_prog_deb.txt"
